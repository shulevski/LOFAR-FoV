...
function setUpId(){
	//loadJSONId(function(response) {
	$.getJSON('/uvis/static/scripts/lofarId.json', {_: new Date().getTime()}, function(response){
	//$.ajax({
			//cache: false,
			//type: 'GET',
			//dataType: 'text json',
			//url: '/uvis/static/scripts/lofarId.json',
...
function loadJSONId(callback) {
	var xobj = new Object;
	xobj = new XMLHttpRequest();
	xobj.overrideMimeType("application/json");
	xobj.open('GET', '/uvis/static/scripts/lofarId.json', true);
	//xobj.open('GET', '/uvis/id/581807', true);
	xobj.send(null);
